        ...
        <div className="relative overflow-hidden" aria-roledescription="carousel">
          ...
          >
            {[...clientLogos, ...clientLogos].map((logo, idx) => (
              <div key={idx} className="shrink-0 w-40 h-16 flex items-center justify-center opacity-80 hover:opacity-100 transition-opacity" role="group" aria-label={logo.name}>
                <img
                  src={logo.src}
                  alt={logo.name}
